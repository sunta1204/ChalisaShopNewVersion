                ...
                <div class="row">
                  ...
                  <div class="container">
                    ...
                    <div class="form-row">
                    	<div class="col">
                    		<div class="form-group white-text">
								...
								<textarea name="address" class="form-control" id="exampleFormControlTextarea4" rows="3"></textarea>
                    	...
                    	<div class="col">
                    		<div class="md-form">
                    			...
                    			<input id="exampleFormControlTextarea5" type="text" name="address_zip" required="" pattern="\d{5}" class="form-control">
                    		</div>
                    	</div>
                    </div>
                    <div class="md-form white-text">
                    	...
                    	<input type="text" name="phoneNumber" required="" pattern="0\d{9}" class="form-control">
